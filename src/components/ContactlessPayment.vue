<template>
  <div class="contactless" :class="{ 'disabled-contactless': selectTotal }">
    <h4>Pay with product card</h4>
    <svg
      @click="contactlessPayment"
      id="Layer_1"
...
export default {
  ...
  methods: {
    contactlessPayment() {
      if (this.$store.state.totalInput === 0) {
        this.$store.commit('contactlessPayment');
      }
    },
  },
  computed: {
